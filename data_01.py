...
def preprocess_point_cloud(pcd, voxel_size=0.05, eps=0.2, min_samples=10):
...
def is_person_by_motion(cluster_id, current_centroid, direction_threshold=0.7, N=20):
...
# PCD 렌더링 및 동영상 저장
def render_pcd_and_save_video(pcd_files, output_dir, video_name, frame_selection_step=5):
